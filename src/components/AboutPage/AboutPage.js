    ...
    <div className={cx('about-back')}>
      <div className={cx('about-contents')}>
        <div className={cx('language')}>
          <div style={{backgroundColor: isENColor}} className={cx('EN')} onClick={() => setKr(false)}>EN</div>
          <div style={{backgroundColor: isKRColor}} className={cx('KR')} onClick={() => setKr(true)}>KR</div>
        </div>
